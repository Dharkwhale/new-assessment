...
export function Button({
  ...
  return (
    <button
      className={cn(
        className,
        "inline-flex items-center justify-center whitespace-nowrap rounded-lg border border-transparent transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 disabled:pointer-events-none disabled:opacity-50",
        variantClass,
        sizeClass,
        // className,
      )}
